                        ...
                        <div className="relative">
                            ...
                            {notifications &&
                                ...
                                <div className={`absolute top-full right-0 mt-1 w-80 rounded-md border border-gray-200 bg-white p-1 overflow-hidden`}>
                                    ...
                                    <div className="px-4 py-3 font-['Poppins'] bg-blue-50 hover:bg-gray-50 transition-colors cursor-pointer w-full">
                                        <div className="flex items-start space-x-3">
                                            <span className=" ">N</span>
                                            <div className="flex-1">
                                                <p className="text-sm/5 text-gray-900 text-start ">New support ticket assigned to you</p>
                                                <p className="mt-1 text-xs text-gray-500">5 minutes ago</p>
                                            </div>
                                            <div className="w-2 h-2 rounded-full mt-1 bg-blue-600 "></div>
                                        </div>
                                    </div>
                                    <div className="px-4 py-3 font-['Poppins'] bg-blue-50 hover:bg-gray-50 transition-colors cursor-pointer w-full">
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm/5 text-gray-900 text-start ">Your report has been reviewed</p>
                                    ...
                                    <div className="px-4 py-3 font-['Poppins'] bg-blue-50 hover:bg-gray-50 transition-colors cursor-pointer w-full">
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm/5 text-gray-900 text-start ">Team meeting in 30 minutes</p>
                                                <p className="mt-1 text-xs text-gray-500">2 hour ago</p>
                                            </div>
                                            <div className="w-2 h-2 rounded-full mt-1 bg-blue-600 "></div>
                                        </div>
                                    </div>
                                    <div className="px-4 py-3 font-['Poppins'] bg-white hover:bg-gray-50 transition-colors cursor-pointer w-full">
                                        <div className="flex items-start space-x-3">
                                            <span className="">N</span>
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm/5 text-gray-900 text-start ">New document shared with you</p>
                                                <p className="mt-1 text-xs text-gray-500">3 hour ago</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="px-4 py-3 font-['Poppins'] bg-white hover:bg-gray-50 transition-colors cursor-pointer w-full">
